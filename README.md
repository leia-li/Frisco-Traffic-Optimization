...
2. Create table in MySQL to store event parameter filter rules (using SQL here)
3. Download test data for signalid 665, May 15 (using this Python script) and run steps #3-#6 with the data, checking count consistency with other ATSPM source.
4. Create derived_atspm, aggr-5min, aggr-15min, aggr-60min, and aggr_lane_metrics tables in MySQL (using file here)
5. Create and run stored procedures to populate 4 tables (using file here)
